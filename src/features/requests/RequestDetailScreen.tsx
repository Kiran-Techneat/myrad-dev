...
export function RequestDetailScreen() {
  ...
  const selReq: ImagingRequest = requests.find((r) => r.id === selectedReqId) ?? requests[1];
            ...
            <div className="dstudy-top">
              ...
              <div className="study-bd">
                <div className="study-nm">
                  {typeOnly}
                  {it.dateLabel && (
                    <span className="study-period-box">
                      <span className="sp-lbl">Period</span>
                      {it.dateLabel}
                    </span>
                  )}
                </div>
