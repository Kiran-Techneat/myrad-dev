...
export function HomeScreen() {
  ...
  return (
    <div className="wrap">
      ...
      <div className="hero" onClick={openGetSheet} style={{ cursor: 'pointer' }}>
        <div>
          <h3>Get my images</h3>
      ...
      <div className="stat-row" style={{ gridTemplateColumns: '1fr 1fr' }}>
        <div className="stat" onClick={() => nav.go('images')} style={{ cursor: 'pointer' }}>
          <div className="stat-top">
            <div className="stat-ico">
              <Icon name="image" />
            </div>
            <div className="stat-num">{readyStudies.length}</div>
          </div>
          <div className="stat-lbl">Images ready to view</div>
        </div>
        <div className="stat" onClick={() => nav.go('requests')} style={{ cursor: 'pointer' }}>
          <div className="stat-top">
            <div className="stat-ico">
              <Icon name="clipboard" />
            </div>
            <div className="stat-num">{requestsInProgress}</div>
          </div>
          <div className="stat-lbl">Requests in progress</div>
        </div>
      </div>
