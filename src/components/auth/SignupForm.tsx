...
export function SignupForm() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className={styles["signup-grid"]}>
        <div className="field">
      ...
      <div className={styles["pwd-guide"]}>
        <div className={cx(styles["pwd-rule"], ruleLen && styles.ok)}>
          <Icon name="check" sw={2.6} />
          At least 8 characters
        </div>
        <div className={cx(styles["pwd-rule"], ruleUpper && styles.ok)}>
          <Icon name="check" sw={2.6} />
          One uppercase letter
        </div>
        <div className={cx(styles["pwd-rule"], ruleNum && styles.ok)}>
          <Icon name="check" sw={2.6} />
          One number
        </div>
        <div className={cx(styles["pwd-rule"], ruleSpecial && styles.ok)}>
          <Icon name="check" sw={2.6} />
